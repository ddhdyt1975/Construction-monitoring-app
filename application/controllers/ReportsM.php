...
class ReportsM extends CI_Controller {
    ...
    function ajax_add_weather($id, $date, $date2, $date3){
        $data = array(
            ...
            'reportid' => 'rep'.''.$id.''.$date3.''.$date.''.$date2.$this->input->post('repperiod'),
            'rep_period'  => $this->input->post('repperiod') 
        );
