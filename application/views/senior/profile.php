...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a  href="<?= base_url('ProfileSM') ?>"><i class="fa fa-user"></i>Profile</a></li>
                            ...
                            <!-- <div class="form-group">
                                <div class="box box-info">
                                    <div class="box-heading">
                                        <h4 class="box-title">
                                        <a data-toggle="collapse" href="#pword"> Change Password<span class="fa fa-arrow-circle-o-down pull-right"></span></a>
                                        </h4>
                                    </div>
...
function changepass(e) {
    ...
    jQuery.ajax({
        type: "POST",
        url:  "<?php echo site_url('ProfileSM/update_password') ?>",    
...
var id = document.getElementById('userid').value;
 ...
 function getUserDetails(id) {
         ...
         $.ajax({
          url : "<?php echo site_url('ProfileSM/userDetails/')?>/" + id,
          type: "GET",
          dataType: "JSON",
...
function editEmail(e) {
    ...
    jQuery.ajax({
    type: "POST",
    url: "<?php echo site_url('ProfileSM/check_email') ?>/" + id,    
...
function editProf() { 
    ...
    var postData = {
        ...
        $.ajax({
         type: "POST",
         url: "<?php echo site_url('ProfileSM/editDetails/')?>/" + id,
         data: postData ,
...
<script>
    $(function() {
        $('#upload_file').submit(function(e) {
            e.preventDefault();
            $.ajaxFileUpload({
                url             :"<?php echo site_url('ProfileSM/upload_file')?>", 
                secureuri       :false,
