...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li  class="active"><a href="ReportsSM"><i class="fa fa-print"></i> Reports</a></li>
        </ol>
    </section>
        ...
        <div class = "row">
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <div class = "form-group input-group">
                        <input name="repdate" id="repdate"   value="<?php echo date("m/d/Y");?>" class="form-control clsDatePicker">
...
<script>
    ...
    function viewDetails(){
        ...
        $.ajax({
            url : "<?php echo site_url('ReportsSM/ProjDetails')?>/"+ projectSelected,
            type: "GET",
            dataType: "JSON",
    ...
    function viewActD(){
        ...
        $.ajax({
        url : "<?php echo site_url('ReportsSM/actDetails/')?>/" + projectSelected +'/'+$('#repdate').val(),
        type: "GET",
        dataType: "JSON",
        success: function(data) {
            if (data.length >0){
    ...
    function getComment(id, dd){
        ...
        $.ajax({
        url : "<?php echo site_url('ReportsSM/actComm/')?>/" + id +'/'+$('#repdate').val(),
        type: "GET",
        dataType: "JSON",
        success: function(data) {
            if (data.length >0){
    ...
    function getComment2(){
        ...
        $.ajax({
        url : "<?php echo site_url('ReportsSM/actComm2/')?>/" + projectSelected +'/'+$('#repdate').val(),
        type: "GET",
        dataType: "JSON",
        success: function(data) {
            if (data.length >0){
    ...
    function viewnextT(){
        ...
        $.ajax({
        url : "<?php echo site_url('ReportsSM/NXTDetails/')?>/" + projectSelected +'/'+$('#repdate').val(),
        type: "GET",
        dataType: "JSON",
            success: function(data) {
                if (data.length >0){
                    for(i=0; i<data.length;i++){
                        $('#tbl21 ul').append('<li><b>'+data[i]['projtsk_name']+'</b> - '+data[i]['nextAct'] +'</li>');
                    };
    ...
    function saveN(){
        ...
        if (save_method =='addnext'){
            url = "<?php echo site_url('ReportsSM/ajax_add_nextact')?>/"+projectSelected+"/"+$('#repdate').val() ;;
        }
        else{
            url = "<?php echo site_url('ReportsSM/ajax_update_nextAct')?>/";
        }
    ...
    function editnextAct(id){
        ...
        $('.help-block').empty();
        $.ajax({
            url : "<?php echo site_url('ReportsSM/ajax_edit_N/')?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data){
  ...
  function MUDetails(){
    ...
    function WandTDetails(){
        $('#wandt').empty();
        $.ajax({
        url : "<?php echo site_url('ReportsSM/WandTDetails/')?>/" + projectSelected +'/'+$('#repdate').val(),
        type: "GET",
        dataType: "JSON",
            success: function(data) {
                for(i=0; i<data.length;i++){
    ...
    function WRKDetails(){
        ...
        $.ajax({
        url : "<?php echo site_url('ReportsSM/WRKDetails/')?>/" + projectSelected +'/'+$('#repdate').val(),
        type: "GET",
        dataType: "JSON",
            success: function(data) {
                //alert(data.length);
    ...
    function saveW(){
        ...
        if (save_method =='addweather'){
            url = "<?php echo site_url('ReportsSM/ajax_add_weather')?>/"+projectSelected+"/"+$('#repdate').val() ;
        }
        else{
    ...
    function saveWRK(){
        ...
        if (save_method =='addwork'){
            url = "<?php echo site_url('ReportsSM/ajax_add_worker')?>/"+projectSelected+"/"+$('#repdate').val() ;;
        }
        else{
            url = "<?php echo site_url('ReportsSM/ajax_update_worker')?>/";
        }
    ...
    function editwrkd(id){
        ...
        //alert(id);
            $.ajax({
                url : "<?php echo site_url('ReportsSM/ajax_edit_work/')?>/" + id,
                type: "GET",
                dataType: "JSON",
                success: function(data)
                {
    ...
    function Viewphotos(){
        ...
        $.ajax({
        url : "<?php echo site_url('ReportsSM/PhotoDetails/')?>/" + projectSelected +'/'+$('#repdate').val(),
        type: "GET",
        dataType: "JSON",
            success: function(data) {
                //alert(data.length);
                if (data.length >0){
                    ...
                    for(i=0; i<data.length;i++){
                        if (data[i]['photo_comment']!=null){
                            $('#asd').append('<div class = "col-lg-6 col-centered" ><img src="'+data[i]['photo']+'" style="width:290px; height:200px;"><br>&nbsp;&nbsp; '+data[i]['photo_comment']+' &nbsp;&nbsp;<a onclick="editcom('+"'"+data[i]['photo_id']+"'"+');"><i class="fa fa-pencil"> <i class="fa fa-comment"></i></i></a></div>');
                        }
                        else{
                            $('#asd').append('<div class = "col-lg-6 col-centered" ><img src="'+data[i]['photo']+'" style="width:290px; height:200px;"><br>&nbsp;&nbsp;<a onclick="editcom('+"'"+data[i]['photo_id']+"'"+');"><i class="fa fa-plus"> <i class="fa fa-comment"></i></i></a></div>');
                        }
                    };
                }
                else{
    ...
    function addPhoto(){
        $.ajaxFileUpload({
            url             :"<?php echo site_url('ReportsSM/upload_file/')?>" + projectSelected+'/'+$('#repdate').val(), 
            secureuri       :false,
    ...
    function editcom(id){
        ...
        $.ajax({
            url : "<?php echo site_url('ReportsSM/ajax_editp/')?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
    ...
    function savecomment(){
        ...
        if (save_method =='addcom'){
            url = "<?php echo site_url('ReportsSM/ajax_add_comment')?>/";
        }
        else{
            url = "<?php echo site_url('ReportsSM/ajax_update_worker')?>/";
        }
          ...
          success: function(data)
          {
            ...
            if(data.status){
                ...
                //reload_table();
                    ...
                    new PNotify({
                        title: 'Hey!',
                        text: 'Comment is saved successfully.',
                        type: 'info',
                        styling: 'bootstrap3',
                        nonblock: {
                            nonblock: true
    ...
    function addPhoto2(){
        ...
        $.ajax({
              url : "<?php echo site_url('ReportsSM/upload_file2/')?>" + projectSelected,
              type: "POST",
              data: $('#upload_file').serialize(),
              dataType: "JSON",
              success: function(data){
    ...
    function deletewrkd(id){
        ...
        {
                $.ajax({
                url : "<?php echo site_url('ReportsSM/ajax_delete_work')?>/"+id,
                type: "POST",
                dataType: "JSON",
                success: function(data)
                {
                    ...
                    new PNotify({
                        title: 'Yeah!',
                        text: 'Worker is deleted successfully.',
                        type: 'success',
                        styling: 'bootstrap3',
                        nonblock: {
                            nonblock: true
    ...
    function deletenextAct(id){
        ...
        {
                $.ajax({
                url : "<?php echo site_url('ReportsSM/ajax_delete_next')?>/"+id,
                type: "POST",
                dataType: "JSON",
                success: function(data)
                {
                    ...
                    new PNotify({
                        title: 'Yeah!',
                        text: 'Next Activity deleted successfully.',
                        type: 'success',
                        styling: 'bootstrap3',
                        nonblock: {
                            nonblock: true
                ...
                error: function (jqXHR, textStatus, errorThrown)
                {
                    new PNotify({
                        title: 'Oh No!',
                        text: 'Something terrible happened. Error deleting Data from the Server',
                        type: 'error',
                        styling: 'bootstrap3'
                    }); 
                }
