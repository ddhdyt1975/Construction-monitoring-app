...
<div class="content-wrapper"> 
   ...
   <section class="content">
        <div class="row">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-11">
                                        <div class="form-group">
                                            <div class = "row">
                                                <div class="col-lg-12">
                                                    <form id="post_form">
                                                        <textarea class="form-control input-sm"  rows="3" id="post_mes" name="post_mes" placeholder="<?php echo $user_info->user_fname?>, Any idea?"></textarea>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-2 pull-right">
                                        <button type="submit" id = "btn-post" onclick="addPost()" class="form-control btn btn-danger btn-sm">Post</button>
                                    </div>
                                </div>  
                            </div>
                        </div>
            ...
            <div class="col-lg-3 "> 
                <div class="box box-default" style="font-size:12px;height:550px;overflow-y:auto;">
                    <div class="box-header with-border">
                        <h3 class="box-title"> Latest Activities</h3>
                    </div>
                    <div class="box-body" >
                        <ul class="timeline" id="seeact_id"> 
                        </ul>
                    </div>
                </div>
            </div>
   ...
   var tid1, tid2;
    ...
    function seeActD(id, mes, user, date , photo){
        ...
        $('#activity').append('<div class="post" >'+
            ...
            '</div>'+
            '<p ><h2>&nbsp;&nbsp;&nbsp;'+mes+
        '</h2></p><div class="page-header"></div><div id ="comments" style="height:250px;overflow-y:auto;"></div>');
        tid1 =id;
        seeComments(id);     
    }
